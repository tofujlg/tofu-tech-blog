  ...
  return (
    <div className="container max-w-6xl py-6 lg:py-10">
      ...
      <section className="mt-8">
        <h2 className="text-2xl font-bold">Imagine</h2>
        <Image
          className="mt-4"
          src="/imagine_icon.png"
          alt="imagine"
          width={100}
          height={100}
        />
        <div className="mt-4">
          ...
          <p>Android</p>
          <p className="text-sm text-muted-foreground mt-3">Tech stack :</p>
          <p>Jetpack Compose, Kotlin</p>
          <div className="mt-4">
            <p className="text-sm text-muted-foreground">Download :</p>
            <div className="flex gap-4">
              <p>Android : <a className="underline" href="https://play.google.com/store/apps/details?id=com.jujekebab.imagine&pcampaignid=web_share" target="_blank" rel="noreferrer">Play Store</a></p>
            </div>
          </div>
        </div>
      </section>
