...
export const metadata: Metadata = {
  ...
  description: "This page is used to show Imagine Privacy Policy",
};

export default async function ImaginePrivacyPolicyPage() {
  return (
    <div className="container max-w-6xl py-6 lg:py-10">
      <div className="flex flex-col items-start gap-4 md:flex-row md:justify-between md:gap-8">
        <div className="flex-1 space-x-4">
          <h1 className="inline-block font-black text-4xl lg:text-5xl">
            Imagine Privacy Policy
          </h1>
        </div>
      </div>
      <hr className="my-8" />
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none text-lg">
        ...
        <p className="text-sm text-muted-foreground mb-6">Last Updated: 2025/04/05</p>

        <section className="mb-8">
          <h3 className="text-2xl font-semibold mb-4">1. Introduction</h3>
          <p className="mb-4">
            This Privacy Policy explains how our application (&quot;imagine&quot;) handles your information. 
